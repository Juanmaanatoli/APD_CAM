...
bool WritePDI(CAPDClient *client, unsigned char address, unsigned long subaddress, unsigned char* buffer, int noofbytes, unsigned long ip_address_h = 0, unsigned short ip_port_h = 0, int timeout = 10);
bool WritePDISafe(CAPDClient *client, unsigned char address, unsigned long subaddress, unsigned char* buffer, int noofbytes, unsigned long ip_address_h = 0, unsigned short ip_port_h = 0, int timeout = 10);
bool ReadPDI(CAPDClient *client, unsigned char address, unsigned long subaddress, unsigned char* buffer, int noofbytes, unsigned long ip_address_h = 0, unsigned short ip_port_h = 0, int timeout = 10);
